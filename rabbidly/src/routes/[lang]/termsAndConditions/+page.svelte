...
<!-- https://www.termsandconditionsgenerator.com/, TODO: move to https://www.e-recht24.de/artikel/ecommerce/6485-rechtssichere-unternehmenswebsite.html -->

<h2><strong>Terms and Conditions</strong></h2>

<p>Welcome to rabbidly!</p>

<p>
	These terms and conditions outline the rules and regulations for the use of rabbidly's Website,
	located at rabbidly.com.
</p>

<p>
	By accessing this website we assume you accept these terms and conditions. Do not continue to use
	rabbidly if you do not agree to take all of the terms and conditions stated on this page.
</p>
...
<p>
	We employ the use of cookies. By accessing rabbidly, you agreed to use cookies in agreement with
	the rabbidly's Privacy Policy.
</p>
...
<p>
	Unless otherwise stated, rabbidly and/or its licensors own the intellectual property rights for
	all material on rabbidly. All intellectual property rights are reserved. You may access this from
	rabbidly for your own personal use subjected to restrictions set in these terms and conditions.
</p>

<p>You must not:</p>
<ul>
	<li>Republish material from rabbidly</li>
	<li>Sell, rent or sub-license material from rabbidly</li>
	<li>Reproduce, duplicate or copy material from rabbidly</li>
	<li>Redistribute content from rabbidly</li>
</ul>
...
<p>
	...
	information in certain areas of the website. rabbidly does not filter, edit, publish or review
	Comments prior to their presence on the website. Comments do not reflect the views and opinions
	of rabbidly,its agents and/or affiliates. Comments reflect the views and opinions of the person
	who post their views and opinions. To the extent permitted by applicable laws, rabbidly shall not
...
<p>
	rabbidly reserves the right to monitor all Comments and to remove any Comments which can be
...
<p>
	You hereby grant rabbidly a non-exclusive license to use, reproduce, edit and authorize others to
...
<p>
	...
	compensates the absence of rabbidly; and (d) the link is in the context of general resource
	information.
</p>
...
<p>
	...
	our website, you must inform us by sending an e-mail to rabbidly. Please include your name, your
...
<p>
	No use of rabbidly's logo or other artwork will be allowed for linking absent a trademark license
	agreement.
</p>
