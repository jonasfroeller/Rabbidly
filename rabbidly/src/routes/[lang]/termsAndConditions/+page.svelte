...
<!-- https://www.termsandconditionsgenerator.com/ später über https://www.e-recht24.de/artikel/ecommerce/6485-rechtssichere-unternehmenswebsite.html -->
...
<p>
  ...
  rabbidly's Website, located at rabbidly.com.
</p>

<p>
  By accessing this website we assume you accept these terms and conditions.
  Do not continue to use rabbidly if you do not agree to take all of the terms
...
<p>
  We employ the use of cookies. By accessing rabbidly, you agreed to use
  cookies in agreement with the rabbidly's Privacy Policy.
</p>
...
<p>
  Unless otherwise stated, rabbidly and/or its licensors own the intellectual
  property rights for all material on rabbidly. All intellectual property
  rights are reserved. You may access this from rabbidly for your own personal
...
<p>
  ...
  opinions and information in certain areas of the website. rabbidly does not
  filter, edit, publish or review Comments prior to their presence on the
  website. Comments do not reflect the views and opinions of rabbidly,its
  ...
  applicable laws, rabbidly shall not be liable for the Comments or for any
...
<p>
  rabbidly reserves the right to monitor all Comments and to remove any
...
<p>
  You hereby grant rabbidly a non-exclusive license to use, reproduce, edit
...
<p>
  ...
  compensates the absence of rabbidly; and (d) the link is in the context of
...
<p>
  ...
  e-mail to rabbidly. Please include your name, your organization name,
...
<p>
  No use of rabbidly's logo or other artwork will be allowed for linking
