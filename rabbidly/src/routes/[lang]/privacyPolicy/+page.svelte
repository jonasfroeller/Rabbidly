...
<!-- https://www.privacypolicygenerator.info/, TODO: move to https://www.e-recht24.de/muster-datenschutzerklaerung.html -->

<h1><strong>Privacy Policy</strong></h1>

<p>
	At rabbidly, accessible from rabbidly.com, one of our main priorities is the privacy of our
	visitors. This Privacy Policy document contains types of information that is collected and
	recorded by rabbidly and how we use it.
</p>
...
<p>
	...
	website with regards to the information that they shared and/or collect in rabbidly. This policy
...
<p>
	rabbidly follows a standard procedure of using log files. These files log visitors when they
...
<p>
	Like any other website, rabbidly uses 'cookies'. These cookies are used to store information
...
<p>
	...
	user data. For easier access, we hyperlinked to their Privacy Policies below.
</p>
...
<p>
	...
	that are used in their respective advertisements and links that appear on rabbidly, which are
...
<p>
	Note that rabbidly has no access to or control over these cookies that are used by third-party
	advertisers.
</p>
...
<p>
	rabbidly's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
...
<p>
	rabbidly does not knowingly collect any Personal Identifiable Information from children under the
