...
<!-- https://www.privacypolicygenerator.info/ später https://www.e-recht24.de/muster-datenschutzerklaerung.html -->

<h1><strong>Privacy Policy</strong></h1>

<p>
  At rabbidly, accessible from rabbidly.com, one of our main priorities is the
  privacy of our visitors. This Privacy Policy document contains types of
  information that is collected and recorded by rabbidly and how we use it.
</p>
...
<p>
  ...
  and/or collect in rabbidly. This policy is not applicable to any information
...
<p>
  rabbidly follows a standard procedure of using log files. These files log
...
<p>
  Like any other website, rabbidly uses 'cookies'. These cookies are used to
...
<p>
  ...
  advertising partners of rabbidly.
</p>

<p>
  Third-party ad servers or ad networks uses technologies like cookies,
  JavaScript, or Web Beacons that are used in their respective advertisements
  and links that appear on rabbidly, which are sent directly to users'
...
<p>
  Note that rabbidly has no access to or control over these cookies that are
...
<p>
  rabbidly's Privacy Policy does not apply to other advertisers or websites.
...
<p>
  rabbidly does not knowingly collect any Personal Identifiable Information
